...
public class ProtocolClient extends ShareFrame {
	...
	public static void main(String[] args) throws Exception {
		String dir = FileSystem.getSystemDir() + "/../share-core/src/";
	...
	public ProtocolClient() throws Exception, ClassNotFoundException, InstantiationException, IllegalAccessException {
		setTitle("share-client protocol版");
		email();
		host();
		//listProtocol();
		input();
...
//			}
	...
	private void write(ProtocolRequest req) {
	...
	private final static void connect(String host, int port) {
		SocketClient socketClient = new SocketClient(host, port, 10, new DefaultSocketlientInitializer());
