...
public class MyClient extends ShareFrame {
	...
	public MyClient() throws Exception, ClassNotFoundException, InstantiationException, IllegalAccessException {
		setTitle("share-client my版");
		email();
		host();
		//listProtocol();
		input();
	...
	private final static void connect(String host, int port) {
		SocketClient socketClient = new SocketClient(host, port, 10, new MySocketlientInitializer());
